...
namespace GSpawn
{
    ...
    {
        [SerializeField]
        [UIFieldConfig("Up axis", "The object local axis that should be treated as up for terrain meshes.", "Terrain mesh", false)]
        private Axis _terrainMeshUpAxis = defaultTerrainMeshUpAxis;
        [SerializeField]
        [UIFieldConfig("Invert axis", "If checked, the terrain mesh up axis is inverted.")]

...
namespace GSpawn
{
    ...
    {
        [SerializeField]
        [UIFieldConfig("Wall cell wire color", "The color which is used to draw the wall cells.", "Modular Walls Spawn", false)]
        private Color _mdWallSpawnCellWireColor = defaultMdWallSpawnCellWireColor;

        [SerializeField]
        [UIFieldConfig("Extension plane fill color", "The fill color used when drawing the extension plane.", "Segments Spawn", true)]
        private Color _segmentsSpawnExtensionPlaneFillColor = defaultSegmentsSpawnExtensionPlaneFillColor;
        [SerializeField]
        [UIFieldConfig("Extension plane border color", "The border color used when drawing the extension plane.")]
        private Color _segmentsSpawnExtensionPlaneBorderColor = defaultSegmentsSpawnExtensionPlaneBorderColor;
        [SerializeField]
        [Min(0.0f)]
        [UIFieldConfig("Extension plane inflate amount", "Specifies how much the size of the extension plane is inflated.")]
        private float _segmentsSpawnExtensionPlaneInflateAmount = defaultSegmentsSpawnExtensionPlaneInflateAmount;
        [SerializeField]
        [UIFieldConfig("Cell wire color", "The color which is used to draw the object spawn cells.")]
        private Color _segmentsSpawnCellWireColor = defaultSegmentsSpawnCellWireColor;
        [SerializeField]
        [UIFieldConfig("X axis color", "The color used to draw the box X axis.", "Box Spawn", true)]
        private Color _boxSpawnXAxisColor = defaultBoxSpawnXAxisColor;
        [SerializeField]
        [UIFieldConfig("Y axis color", "The color used to draw the box Y axis. This is the height axis along which the box can be raised or lowered.")]
        private Color _boxSpawnYAxisColor = defaultBoxSpawnYAxisColor;
        [SerializeField]
        [UIFieldConfig("Z axis color", "The color used to draw the box Z axis.")]
        private Color _boxSpawnZAxisColor = defaultBoxSpawnZAxisColor;
        [SerializeField]
        [Min(0.0f)]
        [UIFieldConfig("X axis length", "The length of the box X axis.")]
        private float _boxSpawnXAxisLength = defaultBoxSpawnXAxisLength;
        [SerializeField]
        [Min(0.0f)]
        [UIFieldConfig("Y axis length", "The length of the box Y axis.")]
        private float _boxSpawnYAxisLength = defaultBoxSpawnYAxisLength;
        [SerializeField]
        [Min(0.0f)]
        [UIFieldConfig("Z axis length", "The length of the box Z axis.")]
        private float _boxSpawnZAxisLength = defaultBoxSpawnZAxisLength;
        [SerializeField]
        [UIFieldConfig("Extension plane fill color", "The fill color used when drawing the extension plane.")]
        ...
        [SerializeField]
        [UIFieldConfig("Show info text", "If checked, the plugin will offer textual information during while using the box spawn tool.")]
        private bool _boxSpawnShowInfoText = defaultBoxSpawnShowInfoText;
        [SerializeField]
        [UIFieldConfig("Paint brush border color", "The paint brush border color.", "Tile Brush Spawn", true)]
        private Color _trSpawnPaintBrushBorderColor = defaultTrSpawnPaintBrushBorderColor;
        [SerializeField]
        [UIFieldConfig("Erase brush border color", "The erase brush border color.")]
        private Color _trSpawnEraseBrushBorderColor = defaultTrSpawnEraseBrushBorderColor;
        [SerializeField]
        [UIFieldConfig("Shadow line color", "The color of the lines that connect a bounding box (e.g. brush, connect point etc) to its shadow.")]
        private Color _trSpawnShadowLineColor = defaultTrSpawnShadowLineColor;
        [SerializeField]
        [UIFieldConfig("Shadow color", "The color of the bounding box (e.g. brush, connect point etc) shadow.")]
        private Color _trSpawnShadowColor = defaultTrSpawnShadowColor;
        [SerializeField]
        [UIFieldConfig("Connect color", "The color used to mark the connection cells when using the Connect tool.")]
        private Color _trSpawnConnectColor = defaultTrSpawnConnectColor;
        [SerializeField]
        [UIFieldConfig("Dynamic grid", "If checked, the tile rule grid will update its Y position based on the selected paint settings such as the paint Y offset.")]
        private bool _trSpawnDynamicGrid = defaultTrSpawnDynamicGrid;
        [SerializeField]
        [UIFieldConfig("Terrain flatten area color", "The color used when drawing the terrain flatten area indicator.", "Props Spawn", true)]
        private Color _propsSpawnTerrainFlattenAreaColor = defaultPropsSpawnTerrainFlattenAreaColor;
        [SerializeField]
        [UIFieldConfig("Brush border color", "The brush border color.", "Scatter Brush Spawn", true)]
        private Color _scatterBrushSpawnBrushBorderColor = defaultScatterBrushSpawnBrushBorderColor;
        [SerializeField]
        [UIFieldConfig("Curve color", "The curve color.", "Curve Spawn", true)]
        private Color _curveSpawnCurveColor = defaultCurveSpawnCurveColor;
        [SerializeField]
        [UIFieldConfig("Segment color", "The color of the segments that connect the curve control points.")]
        private Color _curveSpawnSegmentColor = defaultCurveSpawnSegmentColor;
        [SerializeField]
        [UIFieldConfig("Tick color", "The color of the ticks which represent the curve control points.")]
        private Color _curveSpawnTickColor = defaultCurveSpawnTickColor;
        [SerializeField]
        [UIFieldConfig("Selected tick color", "The color of the ticks which represent the selected curve control points.")]
        private Color _curveSpawnSelectedTickColor = defaultCurveSpawnSelectedTickColor;
        [SerializeField]
        [UIFieldConfig("Tick size", "The size of the ticks which represent the curve control points.")]
        [Min(0.0f)]
        private float _curveSpawnTickSize = defaultCurveSpawnTickSize;
        [SerializeField]
        [UIFieldConfig("Curve smoothness", "A smoothness value used when drawing the curve.")]
        [Range(0.0f, 1.0f)]
        private float _curveSmoothness = defaultCurveSmoothness;
        [SerializeField]
        [UIFieldConfig("Move gizmo drag radius", "This value caps the amount of distance by which control points can be moved away " +
            ...
            "too many objects are being spawned.")]
        [Min(5.0f)]
        private float _curveSpawnMoveGizmoDragRadius = defaultCurveSpawnMoveGizmoDragRadius;
        [SerializeField]
        [UIFieldConfig("Refresh curves when prefab data changes",
        ...
        [SerializeField]
        [UIFieldConfig("Circle color", "The color of the spawn circle.", "Physics Spawn", true)]
        private Color _physicsSpawnCircleColor = defaultPhysicsSpawnCircleColor;
        [SerializeField]
        [UIFieldConfig("Height line color", "The color of the height line.")]
        private Color _physicsSpawnHeightLineColor = defaultPhysicsSpawnHeightLineColor;
        [SerializeField]
        [UIFieldConfig("Marker color", "The color of the marker which sits on the drop surface.")]
        private Color _physicsSpawnMarkerColor = defaultPhysicsSpawnMarkerColor;
        [SerializeField]
        [UIFieldConfig("Marker size", "The size of the marker which sits on the drop surface.")]
        [Min(0.1f)]

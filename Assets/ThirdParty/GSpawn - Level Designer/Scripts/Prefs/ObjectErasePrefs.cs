...
namespace GSpawn
{
    ...
    {
        [SerializeField]
        [UIFieldConfig("Border color", "The color used to draw the border of the 2D erase brush.", "2D Brush", false)]
        private Color _brush2DBorderColor = defaultBrush2DBorderColor;
        [SerializeField]
        [UIFieldConfig("Fill color", "The color used to fill the 2D erase brush.")]
        private Color _brush2DFillColor = defaultBrush2DFillColor;
        [SerializeField]
        [UIFieldConfig("Border color", "The color used to draw the border of the 3D erase brush.", "3D Brush", true)]
        private Color _brush3DBorderColor = defaultBrush3DBorderColor;
        [SerializeField]
        [UIFieldConfig("Height indicator color", "The erase height indicator color.")]

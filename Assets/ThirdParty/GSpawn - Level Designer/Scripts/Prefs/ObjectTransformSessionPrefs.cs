...
namespace GSpawn
{
    ...
    {
        [SerializeField]
        [UIFieldConfig("Rotation relative to grid", "If this is checked, the scene grid will act as a parent for objects involved in modular snap. Those " +
        ...
        [SerializeField]
        [UIFieldConfig("Draw object pivot ticks", "If this is checked, a tick will be drawn at the position of each target object.")]
        private bool _modularSnapDrawObjectPivotTicks = defaultModularSnapDrawObjectPivotTicks;
        [SerializeField]
        [UIFieldConfig("Draw projected object pivot ticks", "If this is checked, a tick will be drawn for the projected position of each target object. This is the position of the object projected onto the scene grid.")]
        private bool _modularSnapDrawProjectedObjectPivotTicks = defaultModularSnapDrawProjectedObjectPivotTicks;
        [SerializeField]
        [UIFieldConfig("Draw object pivot projection lines", "If this is checked, lines will be drawn from each object position to its projected position onto the scene grid.")]
        private bool _modularSnapDrawObjectPivotProjectionLines = defaultModularSnapDrawObjectPivotProjectionLines;
        [SerializeField]
        [UIFieldConfig("Draw object boxes", "If this is checked, a box will be drawn around each target object.")]
        private bool _modularSnapDrawObjectBoxes = defaultModularSnapDrawObjectBoxes;
        [SerializeField]
        [UIFieldConfig("Object pivot tick color", "The color of the object pivot ticks.")]
        private Color _modularSnapObjectPivotTickColor = defaultModularSnapObjectPivotTickColor;
        [SerializeField]
        [UIFieldConfig("Object pivot tick size", "The size of the object pivot ticks.")]
        [Min(0.0f)]
        private float _modularSnapObjectPivotTickSize = defaultModularSnapObjectPivotTickSize;
        [SerializeField]
        [UIFieldConfig("Projected object pivot tick color", "The color of the projected object pivot ticks.")]
        private Color _modularSnapProjectedObjectPivotTickColor = defaultModularSnapProjectedObjectPivotTickColor;
        [SerializeField]
        [UIFieldConfig("Projected object pivot tick size", "The size of the projected object pivot ticks.")]
        [Min(0.0f)]
        private float _modularSnapProjectedObjectPivotTickSize = defaultModularSnapProjectedObjectPivotTickSize;
        [SerializeField]
        [UIFieldConfig("Object pivot projection line color", "The color of the object pivot projection lines.")]
        private Color _modularSnapObjectPivotProjectionLineColor = defaultModularSnapObjectPivotProjectionLineColor;
        [SerializeField]
        [UIFieldConfig("Object box wire color", "The wire color of the target object boxes.")]
        private Color _modularSnapObjectBoxWireColor = defaultModularSnapObjectBoxWireColor;
        [SerializeField]
        [UIFieldConfig("Show info text", "If checked, the plugin will offer textual information during a modular snap session.")]
        private bool _modularSnapShowInfoText = defaultModularSnapShowInfoText;
        [SerializeField]
        [UIFieldConfig("Draw alignment highlights", "If checked, a highlight will be drawn for objects whose positions are aligned with the target objects.")]
        private bool _modularSnapDrawAlignmentHighlights = defaultModularSnapDrawAlignmentHighlights;
        [SerializeField]
        [UIFieldConfig("Alignment highlight radius", "If alignment highlights are turned on, only objects that fall within this radius will be highlighted.")]
        [Min(0.1f)]
        private float _modularSnapAlignmentHighlightRadius = defaultModularSnapAlignmentHighlightRadius;
        [SerializeField]
        [UIFieldConfig("Show alignment hints", "If alignment highlights are turned on, having this checked will display hints related to the highlighted objects.")]
        private bool _modularSnapShowAlignmentHints = defaultModularSnapShowAlignmentHints;
        [SerializeField]
        [UIFieldConfig("Max number of alignment hints", "If alignment hints are turned on, this is the maximum number of hints that will be displayed.")]
        [Min(1)]
        private int _modularSnapMaxNumAlignmentHints = defaultModularSnapMaxNumAlignmentHints;

        [SerializeField]
        [UIFieldConfig("Draw anchor lines", "If this is checked, lines will be drawn from the anchor pivot to each of the target objects.", "Surface Snap", true)]
        private bool _surfaceSnapDrawAnchorLines = defaultSurfaceSnapDrawAnchorLines;
        [SerializeField]
        [UIFieldConfig("Draw anchor tick", "If this is checked, a tick will be drawn at the intersection point between the mouse cursor and the snap surface. This is the anchor point.")]
        ...
        [SerializeField]
        [UIFieldConfig("Anchor line color", "The color of the anchor lines.")]
        private Color _surfaceSnapAnchorLineColor = defaultSurfaceSnapAnchorLineColor;
        [SerializeField]
        [UIFieldConfig("Anchor tick color", "The color of the anchor tick.")]
        private Color _surfaceSnapAnchorTickColor = defaultSurfaceSnapAnchorTickColor;
        [SerializeField]
        [UIFieldConfig("Anchor tick size", "The size of the anchor tick.")]
        [Min(0.0f)]
        private float _surfaceSnapAnchorTickSize = defaultSurfaceSnapAnchorTickSize;
        [SerializeField]
        [UIFieldConfig("Object pivot tick color", "The color of the target object pivot ticks.")]
        private Color _surfaceSnapObjectPivotTickColor = defaultSurfaceSnapObjectPivotTickColor;
        [SerializeField]
        [UIFieldConfig("Object pivot tick size", "The size of the target object pivot ticks.")]
        [Min(0.0f)]
        ...
        [SerializeField]
        [UIFieldConfig("Show info text", "If checked, the plugin will offer textual information during a surface snap session.")]
        private bool _surfaceSnapShowInfoText = defaultSurfaceSnapShowInfoText;
        [SerializeField]
        [UIFieldConfig("Tick color", "The snap pivot tick color.", "Vertex Snap", true)]
        private Color _vertSnapTickColor = defaultVertSnapTickColor;
        [SerializeField]
        [UIFieldConfig("Tick size", "The snap pivot tick size.")]
        [Min(0.0f)]
        private float _vertSnapTickSize = defaultVertSnapTickSize;
        [SerializeField]
        [UIFieldConfig("Triangle wire color", "The wire color of the triangle that contains the selected vertex.")]
        private Color _vertSnapTriangleWireColor = defaultVertSnapTriangleWireColor;
        [SerializeField]
        [UIFieldConfig("Tick color", "The snap pivot tick color.", "Box Snap", true)]
        private Color _boxSnapTickColor = defaultBoxSnapTickColor;
        [SerializeField]
        [UIFieldConfig("Center tick color", "The snap pivot tick color when it coincides with the center of one of the target object boxes.")]
        ...
        [SerializeField]
        [UIFieldConfig("Object box wire color", "The wire color of the object boxes.")]
